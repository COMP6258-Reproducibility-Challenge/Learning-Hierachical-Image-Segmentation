...
class CAST(VisionTransformer): 
    def __init__(self, stop_grad_conv1=False, **kwargs):
        ...
        # self.blocks5, self.pool5 = blocks[4], pools[4] # add level 5
        # ----------------------------------------------------------------------
    ...
    def forward_features(self, x, y):
        ...
        # # add block 5
        # (block5, cls_token5, pool_logit5, centroid5,
        # pool_padding_mask5, pool_inds5, out5) = self._block_operations(
        # centroid4, cls_token4, pool_padding_mask4,
        # self.blocks5, self.pool5, self.norm)

        # out5 = self.pre_logits(out5)

        # intermediates5 = {
        #     'logit5': pool_logit5,
        #     'centroid5': centroid5,
        #     'block5': block5,
        #     'padding_mask5': pool_padding_mask4,
        #     'out5': out5,
        #     'sampled_inds5': pool_inds5,}
        # intermediates.update(intermediates5)
    ...
    def forward(self, x, y):
        ...
        # x = self.head(intermediates['out5']) # add level 5
...
def cast_base(pretrained=True, **kwargs):
    ...
    model = CAST(
        ...
        # num_clusters=[128, 64, 32, 16, 8],  # add level 5
        # depth=[3, 3, 3, 2, 2],  
